...
public class Util {
    ...
    public static Border generateHorizontalMargin() {
        return BorderFactory.createEmptyBorder(0, Constants.DEFAULT_HORIZONTAL_MARGIN, 0,
                Constants.DEFAULT_HORIZONTAL_MARGIN);
    }
    ...
    public static Border generateVerticalMargin() {
        return BorderFactory.createEmptyBorder(Constants.DEFAULT_VERTICAL_MARGIN, 0, Constants.DEFAULT_VERTICAL_MARGIN,
                0);
    }
    ...
    public static boolean ipv4AddressIsValid(String address) {
        ...
        if (segments.length == 4) { // all IPv4 addresses have 4 segments.
            ...
            for (int i = 0; i < segments.length; i++) {
                ...
                } catch (NumberFormatException ex) { // segment is non-numeric and therefore the IP address is not
                                                     // valid.
                    return false;
                }
            }
    ...
    /**
     * Tests the equality of two values, then prints and returns the result. Print
     * string will be displayed on RioLog as an error reading: "Assertion
     * [assertionID] SUCCEEDED/FAILED."
     * 
     * @param assertionName The informational name of the assertion. Will be used in
     *                      the printout.
    ...
    public static boolean assertEquals(String assertionName, Object item1, Object item2) {
        ...
        String message = "Assertion " + assertionName + " " + (success ? "SUCCEEDED" : "FAILED") + "." + " Item 1: "
                + item1.toString() + " | Item 2: " + item2.toString();
